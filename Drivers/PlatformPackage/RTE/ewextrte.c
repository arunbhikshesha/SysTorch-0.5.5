...
// #include "ew_bsp_console.h"   //XXXX SysBrenner keine Konsole 
// #include "ew_bsp_clock.h"     //XXXX SysBrenner keine RTC
...
{
#if 0 //XXXX SysBrenner kein EwConsoleOutput()
	while( *aMessage )
  {
...
#endif //0 //XXXX SysBrenner kein EwConsoleOutput()
}
...
*
*******************************************************************************/
extern unsigned long HAL_GetTick(void); // XXXX Tick f�r Systembrenner

unsigned long EwGetTicks( void )
{
	return HAL_GetTick();  //XXXX  statt EwBspClockGetTicks();
}
...
{
  return 42; //XXXX   EwBspClockGetTime(); Fake return f�r Systembrenner
}
